          ...
          <div class="col-9  text-right">
            ...
            <nav class="site-navigation text-right ml-auto d-none d-lg-block" role="navigation">
              <ul class="site-menu main-menu js-clone-nav ml-auto ">
                ...
                <li class="active"><a href="testimonials.php" class="nav-link">Testimonials</a></li>
            ...
            <div class="col-lg-4 mb-4">
              <div class="testimonial-2 h-100 d-flex flex-column justify-content-between">
                ...
                <div class="d-flex v-card align-items-center">
                  <img src="<?= $testimonial->get_img_src($testimon) ?>" alt="Image" class="img-fluid mr-3">
                  <div class="author-name">
                    <span class="d-block">
                      <?= $testimon['testimonial_user_prenom'] . ' ' . $testimon['testimonial_user_nom'] ?>
                    </span>
                    <span><?= $testimon['testimonial_user_username'] ?></span>
                  </div>
                </div>
              </div>
            </div>
