...
class User
{
	...
	{
		if (empty($_username)) return $_username = $this->username;

		$profileImage = $this->get_user_info($_username)->profileImage;		
		...
		return "data:image/jpeg;base64," . ($profileImage ?? $empty_profile);
	}
}
